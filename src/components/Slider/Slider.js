...
function Slider() {
    ...
    React.useEffect(
        ()=>{
            ...
            //make a call to get the upcoming movie
    ...
    const handleRight = ()=>{
        // if the length of the array minus one is the same as my index position, circle back by setting index position to 0
        //If I'm on the last element, I need to wrap back around to the beginning
    ...
    const handleLeft = ()=>{
        //If I'm on the first element I need to wrap back to the end
        index=== 0?
